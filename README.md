...
> **Important:** Use a **QWERTZ layout without ä, ö, ü** on the main layer. FUTO Keyboard's built-in swipe model works significantly better on standard QWERTZ — umlauts via long-press or a separate key, not as direct layout keys.
